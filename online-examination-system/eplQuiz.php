...
<header>
<div class="container">
	<center><h1>English Premier League Quiz</h1></center>
    <script type="text/javascript">
...
?>
<?php    
$q=mysqli_query($con,"SELECT * FROM epl_questions ORDER BY rand() LIMIT 1 " );
?>    
...
?>
<?php    
$choices=mysqli_query($con,"SELECT * FROM epl_choices WHERE question_number='$question_number'" );    
?>
<?php    
$answer=mysqli_query($con,"SELECT * FROM epl_choices WHERE question_number='$question_number' AND is_correct = '1' " );    
?>    
