...
if(isset($_POST['submit'])){
		...
		//Question query
		$query = "INSERT INTO `acn_questions`(question_number, text)
		...
		if($insert_row){
			foreach($choices as $choice => $value){
				if($value != ''){
					...
					//Choice query
					$query = "INSERT INTO `acn_choices` (question_number, is_correct, text)
...
$query = "SELECT * FROM `acn_questions`";
	//Get The Results
...
<div class="col-md-3"></div><div class="col-md-6">   <form class="form-horizontal title1" name="form" method="POST" action="addquestion_acn.php">
<fieldset>
